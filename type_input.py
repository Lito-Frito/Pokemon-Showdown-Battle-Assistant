...
def find_types():
    ...
    # Format the acceptable_types list as a multi-line string without newline characters
    formatted_acceptable_types = "\n".join(f"'{type}'" for type in acceptable_types)
    
    # TODO: Fix this formatting; seems to be an issue with how {{formatted_acceptable_types}} is handled
    prompt = f"""
You entered: {{pokemon_type}}; Here is a list of all acceptable types:
